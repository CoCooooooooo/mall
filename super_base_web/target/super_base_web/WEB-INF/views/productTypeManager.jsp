...
<head>
    ...
    <script>
        ...
        $(function(){
           $('#pagination').bootstrapPaginator({
               ...
               pageUrl:function(type,page, current){
                    return '${pageContext.request.contextPath}/base/productType/findAll?pageNum='+page;
               },
        ...
        function addProductType(){
            $.post(
                //三个参数  1、请求的url 2、需要传递的数据（名字） 3、回调函数
                '${pageContext.request.contextPath}/base/productType/add',
                ...
                function(result){
                   if(result.status==1){
                       layer.msg(result.message,{
                           ...
                           location.href='${pageContext.request.contextPath}/base/productType/findAll?pageNum='+${pageInfo.pageNum};
                       });
                   }else{
                       layer.msg(result.message,{
                           time:1000,
        ...
        function showProductType(id){
            $.post(
                '${pageContext.request.contextPath}/base/productType/findById',
                {'id':id},
                function(result){
                    if(result.status==1){
        ...
        function modifyName(){
            $.ajax({
                type:'post',
                url:'${pageContext.request.contextPath}/base/productType/modifyName',
        ...
        function deleteProductType(){
            $.get(
                '${pageContext.request.contextPath}/base/productType/removeById',
        ...
        function modifyStatus(id,btn){
            $.get(
                    '${pageContext.request.contextPath}/base/productType/modifyStatus',
                    {'id':id},
                    function(result){
                        if(result.status==1){
                            //局部刷新
